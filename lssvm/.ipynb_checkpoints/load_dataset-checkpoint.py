...
vc2c = pd.read_csv('C:/Users/M/ML/lssvm/vertebral_column_data/column_2C.dat', delim_whitespace=True, header=None)
# dataset for classification between DH (Disk Hernia), Spondylolisthesis (SL) and Normal (NO)
vc3c = pd.read_csv('C:/Users/M/ML/lssvm/vertebral_column_data/column_3C.dat', delim_whitespace=True, header=None)
...
wf24f = pd.read_csv('C:/Users/M/ML/lssvm/Wall-Following_Robot_Navigation/sensor_readings_24.data', header=None)
# dataset with simplified 4 readings (front, left, right and back)
wf4f  = pd.read_csv('C:/Users/M/ML/lssvm/Wall-Following_Robot_Navigation/sensor_readings_4.data',  header=None)
# dataset with simplified 2 readings (front and left)
wf2f  = pd.read_csv('C:/Users/M/ML/lssvm/Wall-Following_Robot_Navigation/sensor_readings_2.data',  header=None)

# Parkinson [https://archive.ics.uci.edu/ml/datasets/parkinsons]
# (31 people, 23 with Parkinson's disease (PD))
temp = pd.read_csv('C:/Users/M/ML/lssvm/parkinsons.data')
